...
export class CreateSimulationDto {
  ...
  @IsPositive({ message: 'O campo "aporteInicial" deve ser um número positivo.' })
  aporteInicial!: number

  @IsNotEmpty({ message: 'O campo "aporteMensal" é obrigatório.' })
  @IsNumber({}, { message: 'O campo "aporteMensal" deve ser um número.' })
  @IsPositive({ message: 'O campo "aporteMensal" deve ser um número positivo.' })
  aporteMensal!: number
  ...
  @IsPositive({ message: 'O campo "tempoInvestimento" deve ser um número positivo.' })
  ...
  @Max(100, { message: 'O campo "reajusteAnual" deve ser menor ou igual a 100.' })
